<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 21:52:42
         compiled from "/var/www/html/shopware5_6/themes/Backend/ExtJs/backend/benchmark/controller/settings.js" */ ?>
<?php /*%%SmartyHeaderCode:13488257815f6ba78abd72c5-76483293%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f915980cb273aa00be98f9458ef940b3c8e8d741' => 
    array (
      0 => '/var/www/html/shopware5_6/themes/Backend/ExtJs/backend/benchmark/controller/settings.js',
      1 => 1597226944,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13488257815f6ba78abd72c5-76483293',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6ba78abe5635_61926212',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6ba78abe5635_61926212')) {function content_5f6ba78abe5635_61926212($_smarty_tpl) {?>
//
//
Ext.define('Shopware.apps.Benchmark.controller.Settings', {
    ...
    onSaveIndustry: function (win, val, callback) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_6/backend/Benchmark/saveIndustry';?>',
            params: {
                industry: val,
...
'
    ...
    sendBenchmarkActiveStatus: function (active, snippets) {
        ...
        Ext.MessageBox.confirm(snippets.confirmationTitle, snippets.confirmationMessage, function (response) {
            ...
            Ext.Ajax.request({
                url: '<?php echo '/shopware5_6/backend/Benchmark/setActive';?>',
                params: {
                    active: active,
                    shopId: me.getShopSelection().getValue()
                },
    ...
    onSaveType: function () {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_6/backend/Benchmark/saveType';?>',
            params: {
                type: selectedValue,
                shopId: me.getShopSelection().getValue()
            },

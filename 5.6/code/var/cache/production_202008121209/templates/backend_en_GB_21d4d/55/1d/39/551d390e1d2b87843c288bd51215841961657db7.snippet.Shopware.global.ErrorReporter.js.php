<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 21:52:40
         compiled from "/var/www/html/shopware5_6/themes/Backend/ExtJs/backend/base/component/Shopware.global.ErrorReporter.js" */ ?>
<?php /*%%SmartyHeaderCode:17159412525f6ba788118329-61728165%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '551d390e1d2b87843c288bd51215841961657db7' => 
    array (
      0 => '/var/www/html/shopware5_6/themes/Backend/ExtJs/backend/base/component/Shopware.global.ErrorReporter.js',
      1 => 1597226944,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17159412525f6ba788118329-61728165',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6ba788131fa6_08446576',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6ba788131fa6_08446576')) {function content_5f6ba788131fa6_08446576($_smarty_tpl) {?>/**
 * Shopware 5
...
'
        ...
        response: {
            name: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'response'/'name','namespace'=>'backend/base/component/Shopware.global.ErrorReporter')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'response'/'name','namespace'=>'backend/base/component/Shopware.global.ErrorReporter'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Server Response<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'response'/'name','namespace'=>'backend/base/component/Shopware.global.ErrorReporter'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            errorOverview: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'response'/'errorOverview','namespace'=>'backend/base/component/Shopware.global.ErrorReporter')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'response'/'errorOverview','namespace'=>'backend/base/component/Shopware.global.ErrorReporter'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Error overview<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'response'/'errorOverview','namespace'=>'backend/base/component/Shopware.global.ErrorReporter'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
        }
    },

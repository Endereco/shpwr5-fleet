<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 21:52:42
         compiled from "/var/www/html/shopware5_6/themes/Backend/ExtJs/backend/article/controller/variant.js" */ ?>
<?php /*%%SmartyHeaderCode:16887523275f6ba78a0353e2-81505916%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '318e473c4b2850f6724db97a729d12740f132be0' => 
    array (
      0 => '/var/www/html/shopware5_6/themes/Backend/ExtJs/backend/article/controller/variant.js',
      1 => 1597226944,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16887523275f6ba78a0353e2-81505916',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6ba78a0680d3_65107120',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6ba78a0680d3_65107120')) {function content_5f6ba78a0680d3_65107120($_smarty_tpl) {?>/**
 * Shopware 5
...
Are you sure you want to delete all selected item variants?<br>The "preselection" variant will not be removed.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'variant'/'message'/'variants_removed','default'=>'Are you sure, you want to delete all selected article variants?','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
'
    ...
    onLoadConfiguratorSet: function(newConfiguratorSet, window) {
        ...
        if (listing.getStore() && listing.getStore().getCount() > 0) {
            Ext.MessageBox.confirm(me.snippets.messages.warningTitle, me.snippets.messages.loadSetWarning, function (response) {
                if ( response === 'yes' ) {
                    Ext.Ajax.request({
                        url:'<?php echo '/shopware5_6/backend/Article/deleteAllVariants';?>',
                        params:{
                            articleId: me.subApplication.article.get('id')
                        },
                        success: function(record, operation) {
    ...
    */
    ...
    generateNumbers: function(offset, window, totalCount, batchSize, progressbar) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_6/backend/Article/regenerateVariantOrderNumbers';?>',
            method: 'POST',
            params: {
                articleId: me.subApplication.article.get('id'),
                offset: offset,

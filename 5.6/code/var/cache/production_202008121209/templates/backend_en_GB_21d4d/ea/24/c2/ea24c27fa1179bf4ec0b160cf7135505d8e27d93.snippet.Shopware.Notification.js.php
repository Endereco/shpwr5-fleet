<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 21:52:40
         compiled from "/var/www/html/shopware5_6/themes/Backend/ExtJs/backend/base/component/Shopware.Notification.js" */ ?>
<?php /*%%SmartyHeaderCode:13720179135f6ba7880c86b5-89204697%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ea24c27fa1179bf4ec0b160cf7135505d8e27d93' => 
    array (
      0 => '/var/www/html/shopware5_6/themes/Backend/ExtJs/backend/base/component/Shopware.Notification.js',
      1 => 1597226944,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13720179135f6ba7880c86b5-89204697',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6ba7880d4dc4_63398250',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6ba7880d4dc4_63398250')) {function content_5f6ba7880d4dc4_63398250($_smarty_tpl) {?>/**
 * Shopware 5
...
Ext.define('Shopware.Notification', {
    ...
    */
    ...
    createGrowlMessage: function(title, text, caller, iconCls, log) {
        ...
        if (log != false) {
            Ext.Ajax.request({
                url: '<?php echo '/shopware5_6/backend/Logger/createLog';?>',
                params: {
                    type: 'backend',
                    key: caller,
                    text: text,
    ...
    getNotificationOptions: function (text) {
        return {
            icon: 'http://localhost/shopware5_6/themes/Frontend/Responsive/frontend/_public/src/img/favicon.ico',
            body: text
        };
    },

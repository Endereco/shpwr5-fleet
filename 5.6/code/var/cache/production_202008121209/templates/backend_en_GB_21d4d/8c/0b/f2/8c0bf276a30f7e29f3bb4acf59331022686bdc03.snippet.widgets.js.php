<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 21:52:40
         compiled from "/var/www/html/shopware5_6/themes/Backend/ExtJs/backend/index/controller/widgets.js" */ ?>
<?php /*%%SmartyHeaderCode:19301432905f6ba788696c29-15262810%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8c0bf276a30f7e29f3bb4acf59331022686bdc03' => 
    array (
      0 => '/var/www/html/shopware5_6/themes/Backend/ExtJs/backend/index/controller/widgets.js',
      1 => 1597226944,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19301432905f6ba788696c29-15262810',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6ba7886c29f8_10078614',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6ba7886c29f8_10078614')) {function content_5f6ba7886c29f8_10078614($_smarty_tpl) {?>/**
 * Shopware 5
...
<?php $_tmp1=ob_get_clean();?><?php if ($_tmp1){?>*/
    ...
    onSaveWidgetPosition: function (column, row, internalId) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_6/backend/widgets/savePosition';?>',
            params: {
                column: column,
                position: row,
                id: internalId
    ...
    onSaveWidgetPositions: function (widgets) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_6/backend/widgets/savePositions';?>',
            jsonData: {
                widgets: widgets
            },
    ...
    onAddWidget: function (win, widgetName, menuItem, data) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_6/backend/widgets/addWidgetView';?>',
            jsonData: {
                id: widget.get('id'),
                column: 0,
    ...
    onCloseWidget: function (widget) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_6/backend/widgets/removeWidgetView';?>',
            params: {
                id: widget.viewId
            },
            callback: function (options, success, res) {
    ...
    onOpenMerchantDetail: function (mode, record) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_6/backend/widgets/requestMerchantForm';?>',
            params: {
                id: ~~(1 * record.get('id')),
    ...
    askForNotificationPermission: function () {
        ...
        if (Notification.permission === 'default') {
            Ext.MessageBox.confirm(
                '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'footer/notification/modal_title','namespace'=>'backend/index/controller/widgets','default'=>'Show notifications on desktop?')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'footer/notification/modal_title','namespace'=>'backend/index/controller/widgets','default'=>'Show notifications on desktop?'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Show notifications on desktop?<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'footer/notification/modal_title','namespace'=>'backend/index/controller/widgets','default'=>'Show notifications on desktop?'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
                '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'footer/notification/modal_content','namespace'=>'backend/index/controller/widgets','default'=>'To show growl notifications, ')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'footer/notification/modal_content','namespace'=>'backend/index/controller/widgets','default'=>'To show growl notifications, '), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
To not miss any notification when you\'re currently using another browser tab or app, Shopware can send incoming notifications to your desktop. To do so, it needs your permission to do so.<br><br>Ask for notification permission?<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'footer/notification/modal_content','namespace'=>'backend/index/controller/widgets','default'=>'To show growl notifications, '), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
', function (response) {
                if (response !== 'yes') {
                    return false;
                }
                ...
                Notification.requestPermission().then( function (result) {
                    if (result === 'denied' ){
                        Ext.MessageBox.alert('<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'footer/notification/denied_title','namespace'=>'backend/index/controller/widgets','default'=>'Denied')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'footer/notification/denied_title','namespace'=>'backend/index/controller/widgets','default'=>'Denied'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Permission denied<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'footer/notification/denied_title','namespace'=>'backend/index/controller/widgets','default'=>'Denied'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
                            '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'footer/notification/denied_content','namespace'=>'backend/index/controller/widgets','default'=>'If you change your mind later, please go to your browser settings for this site.')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'footer/notification/denied_content','namespace'=>'backend/index/controller/widgets','default'=>'If you change your mind later, please go to your browser settings for this site.'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Notification permission has been denied. If you change your mind later, please go to your browser settings for this site to allow notifications.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'footer/notification/denied_content','namespace'=>'backend/index/controller/widgets','default'=>'If you change your mind later, please go to your browser settings for this site.'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
');
                    }

<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 21:52:41
         compiled from "/var/www/html/shopware5_6/themes/Backend/ExtJs/backend/order/controller/detail.js" */ ?>
<?php /*%%SmartyHeaderCode:19813024765f6ba789e9ca80-57878229%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd5d8ae546637fdc256997a04b57d4bc6c7908bcf' => 
    array (
      0 => '/var/www/html/shopware5_6/themes/Backend/ExtJs/backend/order/controller/detail.js',
      1 => 1597226944,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19813024765f6ba789e9ca80-57878229',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6ba789ec66a1_69956528',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6ba789ec66a1_69956528')) {function content_5f6ba789ec66a1_69956528($_smarty_tpl) {?>/**
 * Shopware 5
...
',
        ...
        overwriteDocument: {
            title: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'document'/'overwrite'/'confirmation'/'title','namespace'=>'backend/order/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'document'/'overwrite'/'confirmation'/'title','namespace'=>'backend/order/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Overwrite order document<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'document'/'overwrite'/'confirmation'/'title','namespace'=>'backend/order/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            message: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'document'/'overwrite'/'confirmation'/'message','namespace'=>'backend/order/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'document'/'overwrite'/'confirmation'/'message','namespace'=>'backend/order/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
An overwritten order document cannot be restored. Do you really want to overwrite the document?<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'document'/'overwrite'/'confirmation'/'message','namespace'=>'backend/order/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
        },
...
'
    ...
    onConvertOrder: function(record) {
        ...
        Ext.MessageBox.confirm(me.snippets.convertOrder.title, me.snippets.convertOrder.message, function (response) {
            ...
            Ext.Ajax.request({
                url: '<?php echo '/shopware5_6/backend/CanceledOrder/convertOrder';?>',
                method: 'POST',
                params: {
...
', status.message);
    ...
    onDocumentPreview: function(order, config, panel) {
        window.open('<?php echo '/shopware5_6/backend/Order/createDocument';?>' + '' +

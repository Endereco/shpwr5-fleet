<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 21:52:41
         compiled from "/var/www/html/shopware5_6/themes/Backend/ExtJs/backend/article/view/esd/detail.js" */ ?>
<?php /*%%SmartyHeaderCode:4864081125f6ba789e7ab67-93035269%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '44a02ebab078ba9e5545ec82b11132df1483fa6b' => 
    array (
      0 => '/var/www/html/shopware5_6/themes/Backend/ExtJs/backend/article/view/esd/detail.js',
      1 => 1597226944,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4864081125f6ba789e7ab67-93035269',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6ba789e8d388_62175429',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6ba789e8d388_62175429')) {function content_5f6ba789e8d388_62175429($_smarty_tpl) {?>/**
 * Shopware 5
...
',
            buttonOverwrite: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'esd'/'detail'/'fileupload'/'buttonOverwrite','default'=>'Overwrite','namespace'=>'backend/article/view/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'esd'/'detail'/'fileupload'/'buttonOverwrite','default'=>'Overwrite','namespace'=>'backend/article/view/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Overwrite<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'esd'/'detail'/'fileupload'/'buttonOverwrite','default'=>'Overwrite','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            buttonRename: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'esd'/'detail'/'fileupload'/'buttonRename','default'=>'Rename','namespace'=>'backend/article/view/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'esd'/'detail'/'fileupload'/'buttonRename','default'=>'Rename','namespace'=>'backend/article/view/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Rename<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'esd'/'detail'/'fileupload'/'buttonRename','default'=>'Rename','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            buttonCancel: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'esd'/'detail'/'fileupload'/'buttonCancel','default'=>'Cancel','namespace'=>'backend/article/view/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'esd'/'detail'/'fileupload'/'buttonCancel','default'=>'Cancel','namespace'=>'backend/article/view/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Cancel<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'esd'/'detail'/'fileupload'/'buttonCancel','default'=>'Cancel','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            renameMessage: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'esd'/'detail'/'fileupload'/'reanameMessage','default'=>'You file has been renamed to [0]','namespace'=>'backend/article/view/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'esd'/'detail'/'fileupload'/'reanameMessage','default'=>'You file has been renamed to [0]','namespace'=>'backend/article/view/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Your file has been renamed to [0]<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'esd'/'detail'/'fileupload'/'reanameMessage','default'=>'You file has been renamed to [0]','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
    },
    ...
    getMediaDropZone: function() {
        ...
        var confirmationCallback = function (apply) {
            ...
            me.fileUpload.on('fileUploaded', function () {
                me.fileUpload.requestURL = '<?php echo '/shopware5_6/backend/article/uploadEsdFile';?>';
            }, { single: true });

            if (apply === 'yes') {
                me.fileUpload.requestURL = '<?php echo '/shopware5_6/backend/article/uploadEsdFile/uploadMode/overwrite';?>';
                me.fileUpload.reuploadFiles();
            }
            if (apply === 'no') {
                me.fileUpload.requestURL = '<?php echo '/shopware5_6/backend/article/uploadEsdFile/uploadMode/rename';?>';
                me.fileUpload.reuploadFiles();
            }
        };
        ...
        return me.fileUpload = Ext.create('Shopware.app.FileUpload', {
            name: 'drop-zone',
            requestURL: '<?php echo '/shopware5_6/backend/article/uploadEsdFile';?>',
            showInput: false,
            padding:0,
            checkSize: false,
            checkType: false,
            ...
            listeners: {
                uploadFailed: function (response) {
                    ...
                    Ext.MessageBox.confirm(me.getMessageBoxConfig('<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'esd'/'detail'/'fileexists'/'title','default'=>'File already exists','namespace'=>'backend/article/view/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'esd'/'detail'/'fileexists'/'title','default'=>'File already exists','namespace'=>'backend/article/view/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
The file already exists<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'esd'/'detail'/'fileexists'/'title','default'=>'File already exists','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
', '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'esd'/'detail'/'fileexists'/'message','default'=>'Do you want to overwrite the existing file?','namespace'=>'backend/article/view/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'esd'/'detail'/'fileexists'/'message','default'=>'Do you want to overwrite the existing file?','namespace'=>'backend/article/view/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Do you want to overwrite this file?<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'esd'/'detail'/'fileexists'/'message','default'=>'Do you want to overwrite the existing file?','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
', confirmationCallback));
                ...
                fileUploaded: function (target, response) {
                    ...
                    Ext.Msg.alert('<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'esd'/'detail'/'rename'/'title','default'=>'Upload','namespace'=>'backend/article/view/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'esd'/'detail'/'rename'/'title','default'=>'Upload','namespace'=>'backend/article/view/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Rename<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'esd'/'detail'/'rename'/'title','default'=>'Upload','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>

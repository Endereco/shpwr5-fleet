<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 21:52:42
         compiled from "/var/www/html/shopware5_6/themes/Backend/ExtJs/backend/article/controller/detail.js" */ ?>
<?php /*%%SmartyHeaderCode:13368357535f6ba78a006b91-03118198%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3524e52662db98cbc2689999c6c3450ebb87a07b' => 
    array (
      0 => '/var/www/html/shopware5_6/themes/Backend/ExtJs/backend/article/controller/detail.js',
      1 => 1597226944,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13368357535f6ba78a006b91-03118198',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6ba78a01d292_42800466',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6ba78a01d292_42800466')) {function content_5f6ba78a01d292_42800466($_smarty_tpl) {?>/**
 * Shopware 5
...
',
            message: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'overwriteArticle'/'message','default'=>'Do you really want to overwrite the latest changes?','namespace'=>'backend/article/view/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'overwriteArticle'/'message','default'=>'Do you really want to overwrite the latest changes?','namespace'=>'backend/article/view/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
The product has been changed by another user in the meantime. To prevent overwriting these changes, saving the product was aborted. To show these changes, please close the product and re-open it.<br /><br /><b>Do you want to overwrite the latest changes?</b><?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'overwriteArticle'/'message','default'=>'Do you really want to overwrite the latest changes?','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
        },
    },
    ...
    onDuplicateArticle: function(article) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_6/backend/article/duplicateArticle';?>',
            method: 'POST',
            params: {
    ...
    onArticlePreview: function(article, combo) {
        ...
        var url = '<?php echo '/shopware5_6/backend/Article/previewDetail';?>'
            + '?shopId=' + shopId

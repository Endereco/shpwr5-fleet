<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 21:52:41
         compiled from "/var/www/html/shopware5_6/themes/Backend/ExtJs/backend/customer/controller/stream.js" */ ?>
<?php /*%%SmartyHeaderCode:15790381645f6ba789e24b11-61785581%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd27b5f7ed31b3a84a28b09faaf5aa1f12ba8665a' => 
    array (
      0 => '/var/www/html/shopware5_6/themes/Backend/ExtJs/backend/customer/controller/stream.js',
      1 => 1597226944,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15790381645f6ba789e24b11-61785581',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6ba789e3f5a3_80249736',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6ba789e3f5a3_80249736')) {function content_5f6ba789e3f5a3_80249736($_smarty_tpl) {?>/**
 * Shopware 5
...
Ext.define('Shopware.apps.Customer.controller.Stream', {
    ...
    addCustomerToStream: function(record) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_6/backend/CustomerStream/addCustomerToStream';?>',
            params: {
...
');
    ...
    deleteCustomerFromStream: function(record) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_6/backend/CustomerStream/removeCustomerFromStream';?>',
            params: {
                streamId: stream.get('id'),
                customerId: record.get('id')
            },
...
', next.get('name'), total - streams.length, total),
    ...
    checkIndexState: function() {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_6/backend/CustomerStream/getNotIndexedCount';?>',
...
<?php $_tmp2=ob_get_clean();?><?php if (!$_tmp2){?>*/
    ...
    changeAutoIndex: function(checkbox, newValue) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_6/backend/UserConfig/save';?>',
            params: {
...
<?php $_tmp9=ob_get_clean();?><?php if (!$_tmp9){?>*/
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_6/backend/CustomerStream/loadStream';?>',
            params: {
            ...
            success: function(operation) {
                ...
                me.start(
                    [{
                        url: '<?php echo '/shopware5_6/backend/CustomerStream/indexStream';?>',
                        params: {
...
<?php $_tmp10=ob_get_clean();?><?php if (!$_tmp10){?>*/
        ...
        me.getSearchIndexingParameters(force, function(params) {
            me.start(
                [{
                    url: '<?php echo '/shopware5_6/backend/CustomerStream/buildSearchIndex';?>',
                    params: params
                }],
                callback
            );
    ...
    getSearchIndexingParameters: function(force, callback) {
        Ext.Ajax.request({
            ...
            success: function(operation) {
                ...
                Ext.Ajax.request({
                    url: '<?php echo '/shopware5_6/backend/CustomerStream/getCustomerCount';?>',
                    params: {},
                    success: function (operation) {
    ...
    resetProgressbar: function () {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_6/backend/CustomerStream/getLastFullIndexTime';?>',
            success: function(operation) {
                var response = Ext.decode(operation.responseText);
                Ext.defer(function () {

<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 21:52:41
         compiled from "/var/www/html/shopware5_6/themes/Backend/ExtJs/backend/order/view/detail/overview.js" */ ?>
<?php /*%%SmartyHeaderCode:10985576075f6ba789cf7a61-84582511%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '95516a6045cfca812f524a245c12996d65d629ba' => 
    array (
      0 => '/var/www/html/shopware5_6/themes/Backend/ExtJs/backend/order/view/detail/overview.js',
      1 => 1597226944,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10985576075f6ba789cf7a61-84582511',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6ba789d2bf64_73144424',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6ba789d2bf64_73144424')) {function content_5f6ba789d2bf64_73144424($_smarty_tpl) {?>/**
 * Shopware 5
...
',
            shippingTaxRate: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'overview'/'edit'/'shipping_tax_rate','default'=>'Shipping tax rate','namespace'=>'backend/order/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'overview'/'edit'/'shipping_tax_rate','default'=>'Shipping tax rate','namespace'=>'backend/order/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Shipping tax rate<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'overview'/'edit'/'shipping_tax_rate','default'=>'Shipping tax rate','namespace'=>'backend/order/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
',
            changed: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'overview'/'details'/'changed','default'=>'Last changed','namespace'=>'backend/order/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'overview'/'details'/'changed','default'=>'Last changed','namespace'=>'backend/order/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Last changed<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'overview'/'details'/'changed','default'=>'Last changed','namespace'=>'backend/order/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
        },
...
',
        openCustomer: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'overview'/'details'/'open_customer','default'=>'Open customer','namespace'=>'backend/order/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'overview'/'details'/'open_customer','default'=>'Open customer','namespace'=>'backend/order/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Open customer<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'overview'/'details'/'open_customer','default'=>'Open customer','namespace'=>'backend/order/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
    },

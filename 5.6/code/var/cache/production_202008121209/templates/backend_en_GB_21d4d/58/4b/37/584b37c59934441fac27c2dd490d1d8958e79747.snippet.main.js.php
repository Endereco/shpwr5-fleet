<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 21:52:40
         compiled from "/var/www/html/shopware5_6/themes/Backend/ExtJs/backend/index/controller/main.js" */ ?>
<?php /*%%SmartyHeaderCode:16303779915f6ba788673c21-97265575%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '584b37c59934441fac27c2dd490d1d8958e79747' => 
    array (
      0 => '/var/www/html/shopware5_6/themes/Backend/ExtJs/backend/index/controller/main.js',
      1 => 1597226944,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16303779915f6ba788673c21-97265575',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f6ba788693418_04382442',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6ba788693418_04382442')) {function content_5f6ba788693418_04382442($_smarty_tpl) {?>/**
 * Shopware 5
...
<?php $_tmp8=ob_get_clean();?><?php if ($_tmp8){?>*/
    ...
    checkLoginStatus: function () {
        Ext.TaskManager.start({
            ...
            run: function () {
                Ext.Ajax.request({
                    url: '<?php echo '/shopware5_6/backend/login/getLoginStatus';?>',
                    success: function(response) {
                        var json = Ext.decode(response.responseText);

                        if(!json.success) {
                            window.location.href = '<?php echo '/shopware5_6/backend';?>';
                        }
                    },
                    failure: function() {
                        window.location.href = '<?php echo '/shopware5_6/backend';?>';
    ...
    checkBenchmarksStatus: function () {
        var interval = 10000,
            checkBenchmarksFn = function () {
                Ext.Ajax.request({
                    url: '<?php echo '/shopware5_6/backend/benchmark/checkBenchmarks';?>',
                    success: function(response) {
                        ...
                        if (res.bi) {
                            Shopware.Notification.createStickyGrowlMessage({
                                title: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'title'/'new_benchmark','namespace'=>'backend/index/controller/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'title'/'new_benchmark','namespace'=>'backend/index/controller/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Shopware BI<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'title'/'new_benchmark','namespace'=>'backend/index/controller/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
                                text: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'content'/'new_benchmark','namespace'=>'backend/index/controller/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'content'/'new_benchmark','namespace'=>'backend/index/controller/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
New benchmark data available<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'content'/'new_benchmark','namespace'=>'backend/index/controller/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
                                btnDetail: {
                                    text: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'open','namespace'=>'backend/index/controller/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'open','namespace'=>'backend/index/controller/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Open<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'open','namespace'=>'backend/index/controller/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
                                    callback: function () {
                                        Shopware.app.Application.addSubApplication({
                                            name: 'Shopware.apps.Benchmark',

<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 21:52:41
         compiled from "/var/www/html/shopware5_6/themes/Backend/ExtJs/backend/order/view/list/document.js" */ ?>
<?php /*%%SmartyHeaderCode:17786795815f6ba789df0d35-44696807%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '922f89734f5620226fc460815949f0fab30aced4' => 
    array (
      0 => '/var/www/html/shopware5_6/themes/Backend/ExtJs/backend/order/view/list/document.js',
      1 => 1597226944,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17786795815f6ba789df0d35-44696807',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6ba789df7217_57732555',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6ba789df7217_57732555')) {function content_5f6ba789df7217_57732555($_smarty_tpl) {?>/**
 * Shopware 5
...
<?php $_tmp1=ob_get_clean();?><?php if ($_tmp1){?>*/
    ...
    nameColumn: function(value, metaData, record, rowIndex, colIndex, store, view) {
        var helper = new Ext.dom.Helper,
            ...
            display = type ? type.get('name') : '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'document/unknown','namespace'=>'backend/order/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'document/unknown','namespace'=>'backend/order/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Unknown<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'document/unknown','namespace'=>'backend/order/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
';
        ...
        var spec = {
            tag: 'a',
            html: display,
            href: '<?php echo '/shopware5_6/backend/Order/openPdf';?>/?id=' + record.get('hash'),
            target: '_blank'
        };

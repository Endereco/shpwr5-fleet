<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 21:52:41
         compiled from "/var/www/html/shopware5_6/themes/Backend/ExtJs/backend/article/view/detail/settings.js" */ ?>
<?php /*%%SmartyHeaderCode:18408685555f6ba789d0c0c8-80005218%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '051e4fc67243421e04e46aaabd05eea23ff8c850' => 
    array (
      0 => '/var/www/html/shopware5_6/themes/Backend/ExtJs/backend/article/view/detail/settings.js',
      1 => 1597226944,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18408685555f6ba789d0c0c8-80005218',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6ba789d1dd34_56525928',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6ba789d1dd34_56525928')) {function content_5f6ba789d1dd34_56525928($_smarty_tpl) {?>/**
 * Shopware 5
...
',
            box: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'detail'/'settings'/'on_sale_box','default'=>'If instock <= 0, the article is not available','namespace'=>'backend/article/view/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'detail'/'settings'/'on_sale_box','default'=>'If instock <= 0, the article is not available','namespace'=>'backend/article/view/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
If the stock is <= 0, the item is not available<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'detail'/'settings'/'on_sale_box','default'=>'If instock <= 0, the article is not available','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
        },

...
class ShopwareProductionda39a3ee5e6b4b0d3255bfef95601890afd80709ProjectContainer extends Shopware\Components\DependencyInjection\Container
{
    ...
    {
        return $this->services['cache'] = $this->get('cache_factory')->factory('auto', array('automatic_serialization' => true, 'automatic_cleaning_factor' => 0, 'lifetime' => 3600, 'cache_id_prefix' => '0511f64c3eafeba3f2e1d454b58e9307'), array('hashed_directory_perm' => 493, 'cache_file_perm' => 420, 'hashed_directory_level' => 3, 'cache_dir' => '/var/www/html/shopware5_3/var/cache/production_201801171346/general', 'file_name_prefix' => 'shopware'));
    }
    ...
    {
        return $this->services['db'] = \Shopware\Components\DependencyInjection\Bridge\Db::createEnlightDbAdapter($this->get('dbal_connection'), array('username' => 'user', 'password' => 'pwd', 'dbname' => 'maindb', 'host' => 'db_shopware5_3', 'charset' => 'utf8mb4', 'adapter' => 'pdo_mysql', 'port' => '3306'));
    }
    ...
    {
        return $this->services['dbal_connection'] = \Shopware\Components\DependencyInjection\Bridge\Db::createDbalConnection(array('username' => 'user', 'password' => 'pwd', 'dbname' => 'maindb', 'host' => 'db_shopware5_3', 'charset' => 'utf8mb4', 'adapter' => 'pdo_mysql', 'port' => '3306'), $this->get('modelconfig'), $this->get('model_event_manager'), $this->get('db_connection'));
    }
    ...
    {
        return $this->services['hooks'] = new \Enlight_Hook_HookManager($this->get('events'), $this->get('loader'), array('proxyDir' => '/var/www/html/shopware5_3/var/cache/production_201801171346/proxies', 'proxyNamespace' => 'Shopware_Proxies'));
    }
    ...
    {
        return $this->services['modelannotations'] = $this->get('model_annotations_factory')->factory($this->get('modelconfig'), '/var/www/html/shopware5_3/engine/Shopware/Models');
    }
    protected function getModelconfigService()
    {
        return $this->services['modelconfig'] = new \Shopware\Components\Model\Configuration(array('autoGenerateProxyClasses' => false, 'attributeDir' => '/var/www/html/shopware5_3/var/cache/production_201801171346/doctrine/attributes', 'proxyDir' => '/var/www/html/shopware5_3/var/cache/production_201801171346/doctrine/proxies', 'proxyNamespace' => 'Shopware\\Proxies', 'cacheProvider' => 'auto', 'cacheNamespace' => NULL), $this->get('cache'), new \Shopware\Components\Model\ProxyAwareRepositoryFactory($this->get('hooks')));
    }
    ...
    {
        $a = new \Monolog\Handler\RotatingFileHandler('/var/www/html/shopware5_3/var/log/core_production.log', 14);
    ...
    {
        $a = new \Monolog\Handler\RotatingFileHandler('/var/www/html/shopware5_3/var/log/plugin_production.log', 14);
        $a->pushProcessor($this->get('monolog.processor.uid'));
    ...
    {
        return $this->services['plugins'] = $this->get('plugins_factory')->factory($this, $this->get('loader'), $this->get('events'), $this->get('application'), array('Default' => '/var/www/html/shopware5_3/engine/Shopware/Plugins/Default/', 'Local' => '/var/www/html/shopware5_3/engine/Shopware/Plugins/Local/', 'Community' => '/var/www/html/shopware5_3/engine/Shopware/Plugins/Community/', 'ShopwarePlugins' => '/var/www/html/shopware5_3/custom/plugins/'));
    }
    ...
    {
        return $this->services['shopware.openssl_verificator'] = new \Shopware\Components\OpenSSLVerifier('/var/www/html/shopware5_3/engine/Shopware/Components/HttpClient/public.key');
    }
    ...
    {
        return $this->services['shopware.requirements'] = new \Shopware\Components\Check\Requirements('/var/www/html/shopware5_3/engine/Shopware/Components/Check/Data/System.xml', $this->get('db_connection'));
    }
    ...
    {
        return $this->services['shopware.snippet_database_handler'] = new \Shopware\Components\Snippet\DatabaseHandler($this->get('models'), $this->get('db'), '/var/www/html/shopware5_3');
    }
    protected function getShopware_SnippetQueryHandlerService()
    {
        return $this->services['shopware.snippet_query_handler'] = new \Shopware\Components\Snippet\QueryHandler('/var/www/html/shopware5_3/snippets/');
    }
    ...
    {
        return $this->services['shopware_plugininstaller.legacy_plugin_installer'] = new \Shopware\Bundle\PluginInstallerBundle\Service\LegacyPluginInstaller($this->get('models'), $this->get('plugins'), array('Default' => '/var/www/html/shopware5_3/engine/Shopware/Plugins/Default/', 'Local' => '/var/www/html/shopware5_3/engine/Shopware/Plugins/Local/', 'Community' => '/var/www/html/shopware5_3/engine/Shopware/Plugins/Community/', 'ShopwarePlugins' => '/var/www/html/shopware5_3/custom/plugins/'));
    }
    protected function getShopwarePlugininstaller_PluginDownloadServiceService()
    {
        return $this->services['shopware_plugininstaller.plugin_download_service'] = new \Shopware\Bundle\PluginInstallerBundle\Service\DownloadService('/var/www/html/shopware5_3', array('Default' => '/var/www/html/shopware5_3/engine/Shopware/Plugins/Default/', 'Local' => '/var/www/html/shopware5_3/engine/Shopware/Plugins/Local/', 'Community' => '/var/www/html/shopware5_3/engine/Shopware/Plugins/Community/', 'ShopwarePlugins' => '/var/www/html/shopware5_3/custom/plugins/'), $this->get('shopware_plugininstaller.store_client'), $this->get('dbal_connection'));
    }
    protected function getShopwarePlugininstaller_PluginInstallerService()
    {
        return $this->services['shopware_plugininstaller.plugin_installer'] = new \Shopware\Bundle\PluginInstallerBundle\Service\PluginInstaller($this->get('models'), $this->get('shopware.snippet_database_handler'), $this->get('shopware.plugin_requirement_validator'), $this->get('db_connection'), '/var/www/html/shopware5_3/custom/plugins/');
    }
    ...
    {
        return $this->services['shopware_search_es.product_number_search_factory'] = new \Shopware\Bundle\SearchBundleES\DependencyInjection\Factory\ProductNumberSearchFactory(array(0 => $this->get('shopware_search_es.category_condition_handler'), 1 => $this->get('shopware_search_es.product_dimensions_facet_handler'), 2 => $this->get('shopware_search_es.weight_condition_handler'), 3 => $this->get('shopware_search_es.length_condition_handler'), 4 => $this->get('shopware_search_es.height_condition_handler'), 5 => $this->get('shopware_search_es.width_condition_handler'), 6 => $this->get('shopware_search_es.combined_condition_handler'), 7 => $this->get('shopware_search_es.combined_condition_facet_handler'), 8 => $this->get('shopware_search_es.product_stock_sorting_handler'), 9 => $this->get('shopware_search_es.search_random_sorting_handler'), 10 => $this->get('shopware_search_es.search_ranking_sorting_handler'), 11 => $this->get('shopware_search_es.release_date_sorting_handler'), 12 => $this->get('shopware_search_es.product_name_sorting_handler'), 13 => $this->get('shopware_search_es.product_attribute_sorting_handler'), 14 => $this->get('shopware_search_es.popularity_sorting_handler'), 15 => $this->get('shopware_search_es.price_sorting_handler'), 16 => $this->get('shopware_search_es.category_facet_handler'), 17 => $this->get('shopware_search_es.product_attribute_facet_handler'), 18 => $this->get('shopware_search_es.vote_average_facet_handler'), 19 => $this->get('shopware_search_es.immediate_delivery_facet_handler'), 20 => $this->get('shopware_search_es.shipping_free_facet_handler'), 21 => $this->get('shopware_search_es.property_facet_handler'), 22 => $this->get('shopware_search_es.manufacturer_facet_handler'), 23 => $this->get('shopware_search_es.price_facet_handler'), 24 => $this->get('shopware_search_es.is_available_condition_handler'), 25 => $this->get('shopware_search_es.sales_condition_handler'), 26 => $this->get('shopware_search_es.vote_average_condition_handler'), 27 => $this->get('shopware_search_es.shipping_free_condition_handler'), 28 => $this->get('shopware_search_es.search_term_condition_handler'), 29 => $this->get('shopware_search_es.property_condition_handler'), 30 => $this->get('shopware_search_es.product_attribute_condition_handler'), 31 => $this->get('shopware_search_es.price_condition_handler'), 32 => $this->get('shopware_search_es.manufacturer_condition_handler'), 33 => $this->get('shopware_search_es.immediate_delivery_condition_handler'), 34 => $this->get('shopware_search_es.release_date_condition_handler'), 35 => $this->get('shopware_search_es.create_date_condition_handler'), 36 => $this->get('shopware_search_es.is_new_condtion_handler'), 37 => $this->get('shopware_search_es.has_pseudo_price_condtion_handler'), 38 => $this->get('shopware_search_es.customer_group_condition_handler'), 39 => $this->get('shopware_search_es.ordernumber_condition_handler'), 40 => $this->get('shopware_search_es.closeout_condition_handler'), 41 => $this->get('shopware_search_es.similar_product_condition_handler')));
    }
    ...
    {
        return $this->services['theme_compiler'] = new \Shopware\Components\Theme\Compiler('/var/www/html/shopware5_3', $this->get('oyejorge_compiler'), $this->get('theme_path_resolver'), $this->get('theme_inheritance'), $this->get('theme_service'), $this->get('js_compressor'), $this->get('events'), $this->get('theme_timestamp_persistor'));
    }
    ...
    {
        return $this->services['theme_path_resolver'] = new \Shopware\Components\Theme\PathResolver('/var/www/html/shopware5_3', array('Default' => '/var/www/html/shopware5_3/engine/Shopware/Plugins/Default/', 'Local' => '/var/www/html/shopware5_3/engine/Shopware/Plugins/Local/', 'Community' => '/var/www/html/shopware5_3/engine/Shopware/Plugins/Community/', 'ShopwarePlugins' => '/var/www/html/shopware5_3/custom/plugins/'), $this->get('template'));
    }
    ...
    {
        return $this->services['thumbnail_manager'] = new \Shopware\Components\Thumbnail\Manager($this->get('thumbnail_generator_basic'), '/var/www/html/shopware5_3', $this->get('events'), $this->get('shopware_media.media_service'));
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/var/www/html/shopware5_3',
            'kernel.environment' => 'production',
            'kernel.debug' => false,
            'kernel.name' => 'Shopware',
            'kernel.cache_dir' => '/var/www/html/shopware5_3/var/cache/production_201801171346',
            'kernel.logs_dir' => '/var/www/html/shopware5_3/var/log',
            ...
            'shopware.cdn.adapters.local.path' => '/var/www/html/shopware5_3',
            ...
            'shopware.db.host' => 'db_shopware5_3',
            ...
            'shopware.plugin_directories' => array(
                'Default' => '/var/www/html/shopware5_3/engine/Shopware/Plugins/Default/',
                'Local' => '/var/www/html/shopware5_3/engine/Shopware/Plugins/Local/',
                'Community' => '/var/www/html/shopware5_3/engine/Shopware/Plugins/Community/',
                'ShopwarePlugins' => '/var/www/html/shopware5_3/custom/plugins/',
            ),
            'shopware.plugin_directories.default' => '/var/www/html/shopware5_3/engine/Shopware/Plugins/Default/',
            'shopware.plugin_directories.local' => '/var/www/html/shopware5_3/engine/Shopware/Plugins/Local/',
            'shopware.plugin_directories.community' => '/var/www/html/shopware5_3/engine/Shopware/Plugins/Community/',
            'shopware.plugin_directories.shopwareplugins' => '/var/www/html/shopware5_3/custom/plugins/',
            'shopware.template' => array(
                ...
                'charset' => 'utf-8',
                'forceCache' => false,
                'cacheDir' => '/var/www/html/shopware5_3/var/cache/production_201801171346/templates',
                'compileDir' => '/var/www/html/shopware5_3/var/cache/production_201801171346/templates',
            ),
            ...
            'shopware.template.cachedir' => '/var/www/html/shopware5_3/var/cache/production_201801171346/templates',
            'shopware.template.compiledir' => '/var/www/html/shopware5_3/var/cache/production_201801171346/templates',
            'shopware.mail' => array(
                'charset' => 'utf-8',
            ),
            ...
            'shopware.httpcache' => array(
                ...
                'cache_dir' => '/var/www/html/shopware5_3/var/cache/production_201801171346/html',
                'cache_cookies' => array(
                    0 => 'shop',
                    1 => 'currency',
            ...
            'shopware.httpcache.cache_dir' => '/var/www/html/shopware5_3/var/cache/production_201801171346/html',
            ...
            'shopware.cache' => array(
                'frontendOptions' => array(
                    ...
                    'lifetime' => 3600,
                    'cache_id_prefix' => '0511f64c3eafeba3f2e1d454b58e9307',
                ),
                'backend' => 'auto',
                'backendOptions' => array(
                    ...
                    'cache_dir' => '/var/www/html/shopware5_3/var/cache/production_201801171346/general',
            ...
            'shopware.cache.frontendoptions.cache_id_prefix' => '0511f64c3eafeba3f2e1d454b58e9307',
            ...
            'shopware.cache.backendoptions.cache_dir' => '/var/www/html/shopware5_3/var/cache/production_201801171346/general',
            'shopware.cache.backendoptions.file_name_prefix' => 'shopware',
            'shopware.hook' => array(
                'proxyDir' => '/var/www/html/shopware5_3/var/cache/production_201801171346/proxies',
                'proxyNamespace' => 'Shopware_Proxies',
            ),
            'shopware.hook.proxydir' => '/var/www/html/shopware5_3/var/cache/production_201801171346/proxies',
            'shopware.hook.proxynamespace' => 'Shopware_Proxies',
            'shopware.model' => array(
                'autoGenerateProxyClasses' => false,
                'attributeDir' => '/var/www/html/shopware5_3/var/cache/production_201801171346/doctrine/attributes',
                'proxyDir' => '/var/www/html/shopware5_3/var/cache/production_201801171346/doctrine/proxies',
                'proxyNamespace' => 'Shopware\\Proxies',
                'cacheProvider' => 'auto',
                'cacheNamespace' => NULL,
            ),
            'shopware.model.autogenerateproxyclasses' => false,
            'shopware.model.attributedir' => '/var/www/html/shopware5_3/var/cache/production_201801171346/doctrine/attributes',
            'shopware.model.proxydir' => '/var/www/html/shopware5_3/var/cache/production_201801171346/doctrine/proxies',

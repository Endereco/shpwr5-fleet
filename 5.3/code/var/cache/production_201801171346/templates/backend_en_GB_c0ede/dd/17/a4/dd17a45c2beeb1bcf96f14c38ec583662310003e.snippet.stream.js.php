<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 22:05:55
         compiled from "/var/www/html/shopware5_3/themes/Backend/ExtJs/backend/customer/controller/stream.js" */ ?>
<?php /*%%SmartyHeaderCode:9585970035f6baaa3388249-69176304%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dd17a45c2beeb1bcf96f14c38ec583662310003e' => 
    array (
      0 => '/var/www/html/shopware5_3/themes/Backend/ExtJs/backend/customer/controller/stream.js',
      1 => 1516189600,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9585970035f6baaa3388249-69176304',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6baaa33a3479_20960704',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6baaa33a3479_20960704')) {function content_5f6baaa33a3479_20960704($_smarty_tpl) {?>/**
 * Shopware 5
...
', next.get('name'), total - streams.length, total),
    ...
    checkIndexState: function() {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_3/backend/CustomerStream/getNotIndexedCount';?>',
...
<?php $_tmp2=ob_get_clean();?><?php if (!$_tmp2){?>*/
    ...
    changeAutoIndex: function(checkbox, newValue) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_3/backend/UserConfig/save';?>',
            params: {
...
<?php $_tmp9=ob_get_clean();?><?php if (!$_tmp9){?>*/
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_3/backend/CustomerStream/loadStream';?>',
            params: {
            ...
            success: function(operation) {
                ...
                me.start(
                    [{
                        url: '<?php echo '/shopware5_3/backend/CustomerStream/indexStream';?>',
                        params: {
...
<?php $_tmp10=ob_get_clean();?><?php if (!$_tmp10){?>*/
        ...
        me.getSearchIndexingParameters(force, function(params) {
            me.start(
                [{
                    url: '<?php echo '/shopware5_3/backend/CustomerStream/buildSearchIndex';?>',
                    params: params
                }],
                callback
            );
    ...
    getSearchIndexingParameters: function(force, callback) {
        Ext.Ajax.request({
            ...
            success: function(operation) {
                ...
                Ext.Ajax.request({
                    url: '<?php echo '/shopware5_3/backend/CustomerStream/getCustomerCount';?>',
                    params: {},
                    success: function (operation) {
    ...
    resetProgressbar: function () {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_3/backend/CustomerStream/getLastFullIndexTime';?>',
            success: function(operation) {
                var response = Ext.decode(operation.responseText);
                Ext.defer(function () {

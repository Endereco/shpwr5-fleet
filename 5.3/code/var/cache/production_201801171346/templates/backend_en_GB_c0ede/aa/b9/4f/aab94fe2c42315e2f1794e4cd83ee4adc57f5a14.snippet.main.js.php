<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 22:05:53
         compiled from "/var/www/html/shopware5_3/themes/Backend/ExtJs/backend/index/controller/main.js" */ ?>
<?php /*%%SmartyHeaderCode:5234488345f6baaa1f02c47-99940463%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'aab94fe2c42315e2f1794e4cd83ee4adc57f5a14' => 
    array (
      0 => '/var/www/html/shopware5_3/themes/Backend/ExtJs/backend/index/controller/main.js',
      1 => 1516189600,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5234488345f6baaa1f02c47-99940463',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f6baaa1f1ce63_79354154',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6baaa1f1ce63_79354154')) {function content_5f6baaa1f1ce63_79354154($_smarty_tpl) {?>/**
 * Shopware 5
...
<?php $_tmp6=ob_get_clean();?><?php if ($_tmp6){?>*/
    ...
    checkLoginStatus: function() {
        Ext.TaskManager.start({
            ...
            run: function() {
                Ext.Ajax.request({
                    url: '<?php echo '/shopware5_3/backend/login/getLoginStatus';?>',
                    success: function(response) {
                        var json = Ext.decode(response.responseText);

                        if(!json.success) {
                            window.location.href = '<?php echo '/shopware5_3/backend';?>';
                        }
                    },
                    failure: function() {
                        window.location.href = '<?php echo '/shopware5_3/backend';?>';

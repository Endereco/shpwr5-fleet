<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 22:05:55
         compiled from "/var/www/html/shopware5_3/themes/Backend/ExtJs/backend/article/controller/variant.js" */ ?>
<?php /*%%SmartyHeaderCode:13129231025f6baaa3495ef2-02917208%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b297b54e16c597b8fc040f254b9f4cff772ca797' => 
    array (
      0 => '/var/www/html/shopware5_3/themes/Backend/ExtJs/backend/article/controller/variant.js',
      1 => 1516189600,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13129231025f6baaa3495ef2-02917208',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6baaa34c75c5_54726521',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6baaa34c75c5_54726521')) {function content_5f6baaa34c75c5_54726521($_smarty_tpl) {?>/**
 * Shopware 5
...
'
    ...
    onLoadConfiguratorSet: function(newConfiguratorSet, window) {
        ...
        if (listing.getStore() && listing.getStore().getCount() > 0) {
            Ext.MessageBox.confirm(me.snippets.messages.warningTitle, me.snippets.messages.loadSetWarning, function (response) {
                if ( response === 'yes' ) {
                    Ext.Ajax.request({
                        url:'<?php echo '/shopware5_3/backend/Article/deleteAllVariants';?>',
                        params:{
                            articleId: me.subApplication.article.get('id')
                        },
                        success: function(record, operation) {
    ...
    */
    ...
    generateNumbers: function(offset, window, totalCount, batchSize, progressbar) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_3/backend/Article/regenerateVariantOrderNumbers';?>',
            method: 'POST',
            params: {
                articleId: me.subApplication.article.get('id'),
                offset: offset,

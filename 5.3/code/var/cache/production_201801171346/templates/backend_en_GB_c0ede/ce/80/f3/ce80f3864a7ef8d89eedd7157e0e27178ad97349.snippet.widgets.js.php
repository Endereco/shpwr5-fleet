<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 22:05:53
         compiled from "/var/www/html/shopware5_3/themes/Backend/ExtJs/backend/index/controller/widgets.js" */ ?>
<?php /*%%SmartyHeaderCode:7165548995f6baaa1f1ffd1-37006758%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ce80f3864a7ef8d89eedd7157e0e27178ad97349' => 
    array (
      0 => '/var/www/html/shopware5_3/themes/Backend/ExtJs/backend/index/controller/widgets.js',
      1 => 1516189600,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7165548995f6baaa1f1ffd1-37006758',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6baaa1f2b576_03197110',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6baaa1f2b576_03197110')) {function content_5f6baaa1f2b576_03197110($_smarty_tpl) {?>/**
 * Shopware 5
...
<?php $_tmp1=ob_get_clean();?><?php if ($_tmp1){?>*/
    ...
    onSaveWidgetPosition: function (column, row, internalId) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_3/backend/widgets/savePosition';?>',
            params: {
                column: column,
                position: row,
                id: internalId
    ...
    onSaveWidgetPositions: function (widgets) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_3/backend/widgets/savePositions';?>',
            jsonData: {
                widgets: widgets
            },
    ...
    onAddWidget: function (win, widgetName, menuItem) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_3/backend/widgets/addWidgetView';?>',
            jsonData: {
                id: widget.get('id'),
                column: 0,
    ...
    onCloseWidget: function (widget) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_3/backend/widgets/removeWidgetView';?>',
            params: {
                id: widget.viewId
            },
            callback: function (options, success, res) {
    ...
    onOpenMerchantDetail: function (mode, record) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_3/backend/widgets/requestMerchantForm';?>',
            params: {
                id: ~~(1 * record.get('id')),

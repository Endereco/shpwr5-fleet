<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 22:05:55
         compiled from "/var/www/html/shopware5_3/themes/Backend/ExtJs/backend/article_list/controller/main.js" */ ?>
<?php /*%%SmartyHeaderCode:9820108945f6baaa328e9e6-68769364%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a9cc43125aedf8a8fa0e978c3d6aed4cd3b62d4d' => 
    array (
      0 => '/var/www/html/shopware5_3/themes/Backend/ExtJs/backend/article_list/controller/main.js',
      1 => 1516189600,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9820108945f6baaa328e9e6-68769364',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6baaa329a339_18967424',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6baaa329a339_18967424')) {function content_5f6baaa329a339_18967424($_smarty_tpl) {?>/**
 * Shopware 5
...
Ext.define('Shopware.apps.ArticleList.controller.Main', {
    ...
    loadDetailModelFields: function () {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_3/backend/ArticleList/columnConfig';?>',
            params: {
                resource: 'product'
            },
            method: 'GET',
    ...
    createDetailModel: function (data) {
        ...
        Ext.define('Shopware.apps.ArticleList.model.Detail', {
            ...
            proxy: {
                 ...
                 */
                api: {
                    create: '<?php echo '/shopware5_3/backend/ArticleList/saveSingleEntity';?>',
                    update: '<?php echo '/shopware5_3/backend/ArticleList/saveSingleEntity';?>',
                    destroy: '<?php echo '/shopware5_3/backend/ArticleList/deleteProduct';?>'
                },

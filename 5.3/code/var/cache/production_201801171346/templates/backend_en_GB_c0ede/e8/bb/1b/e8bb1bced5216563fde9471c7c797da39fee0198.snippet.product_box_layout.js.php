<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 22:05:53
         compiled from "/var/www/html/shopware5_3/themes/Backend/ExtJs/backend/base/store/product_box_layout.js" */ ?>
<?php /*%%SmartyHeaderCode:14173184815f6baaa1a52d83-98923170%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e8bb1bced5216563fde9471c7c797da39fee0198' => 
    array (
      0 => '/var/www/html/shopware5_3/themes/Backend/ExtJs/backend/base/store/product_box_layout.js',
      1 => 1516189600,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14173184815f6baaa1a52d83-98923170',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6baaa1a5c828_12062396',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6baaa1a5c828_12062396')) {function content_5f6baaa1a5c828_12062396($_smarty_tpl) {?>/**
 * Shopware 5
    ...
    constructor: function(config) {
        ...
        if (this.getConfigValue(config, 'displayExtendLayout')) {
            data.push({
                ...
                image: '/shopware5_3/themes/Backend/ExtJs/backend/_resources/images/category/layout_box_parent.png'
            });
        }
        if (this.getConfigValue(config, 'displayBasicLayout')) {
            data.push({
                ...
                image: '/shopware5_3/themes/Backend/ExtJs/backend/_resources/images/category/layout_box_basic.png'
            });
        }
        if (this.getConfigValue(config, 'displayMinimalLayout')) {
            data.push({
                ...
                image: '/shopware5_3/themes/Backend/ExtJs/backend/_resources/images/category/layout_box_minimal.png'
            });
        }
        if (this.getConfigValue(config, 'displayImageLayout')) {
            data.push({
                ...
                image: '/shopware5_3/themes/Backend/ExtJs/backend/_resources/images/category/layout_box_image.png'
            });
        }
        if (this.getConfigValue(config, 'displayListLayout')) {
            data.push({
                ...
                image: '/shopware5_3/themes/Backend/ExtJs/backend/_resources/images/category/layout_box_list.png'
            });
        }

...
class ShopwareProductionda39a3ee5e6b4b0d3255bfef95601890afd80709ProjectContainer extends Shopware\Components\DependencyInjection\Container
{
    ...
    {
        return $this->services['cache'] = $this->get('cache_factory')->factory('auto', array('automatic_serialization' => true, 'automatic_cleaning_factor' => 0, 'lifetime' => 3600, 'cache_id_prefix' => 'ab951cb28e3dfd3c50f80da67e7a13b5'), array('hashed_directory_perm' => 493, 'cache_file_perm' => 420, 'hashed_directory_level' => 3, 'cache_dir' => '/var/www/html/shopware5_4/var/cache/production_201807181357/general', 'file_name_prefix' => 'shopware'), $this->get('shopware.release'));
    }
    ...
    {
        return $this->services['db'] = \Shopware\Components\DependencyInjection\Bridge\Db::createEnlightDbAdapter($this->get('dbal_connection'), array('username' => 'user', 'password' => 'pwd', 'dbname' => 'maindb', 'host' => 'db_shopware5_4', 'charset' => 'utf8mb4', 'adapter' => 'pdo_mysql', 'port' => '3306'));
    }
    ...
    {
        return $this->services['dbal_connection'] = \Shopware\Components\DependencyInjection\Bridge\Db::createDbalConnection(array('username' => 'user', 'password' => 'pwd', 'dbname' => 'maindb', 'host' => 'db_shopware5_4', 'charset' => 'utf8mb4', 'adapter' => 'pdo_mysql', 'port' => '3306'), $this->get('modelconfig'), $this->get('model_event_manager'), $this->get('db_connection'));
    }
    ...
    {
        return $this->services['hooks'] = new \Enlight_Hook_HookManager($this->get('events'), $this->get('loader'), array('proxyDir' => '/var/www/html/shopware5_4/var/cache/production_201807181357/proxies', 'proxyNamespace' => 'Shopware_Proxies'));
    }
    ...
    {
        return $this->services['modelannotations'] = $this->get('model_annotations_factory')->factory($this->get('modelconfig'), '/var/www/html/shopware5_4/engine/Shopware/Models');
    }
    protected function getModelconfigService()
    {
        return $this->services['modelconfig'] = new \Shopware\Components\Model\Configuration(array('autoGenerateProxyClasses' => false, 'attributeDir' => '/var/www/html/shopware5_4/var/cache/production_201807181357/doctrine/attributes', 'proxyDir' => '/var/www/html/shopware5_4/var/cache/production_201807181357/doctrine/proxies', 'proxyNamespace' => 'Shopware\\Proxies', 'cacheProvider' => 'auto', 'cacheNamespace' => NULL), $this->get('cache'), new \Shopware\Components\Model\ProxyAwareRepositoryFactory($this->get('hooks')), $this->get('shopware.release'));
    }
    ...
    {
        $a = new \Monolog\Handler\RotatingFileHandler('/var/www/html/shopware5_4/var/log/core_production.log', 14, 400);
    ...
    {
        return $this->services['optin_cleanup_cron_job_subscriber'] = new \Shopware\Components\Register\OptinCleanupSubscriber($this->get('shopware.components.optin_cleanup_service'));
    }
    ...
    {
        $a = new \Monolog\Handler\RotatingFileHandler('/var/www/html/shopware5_4/var/log/plugin_production.log', 14, 400);
        $a->pushProcessor($this->get('monolog.processor.uid'));
    ...
    {
        return $this->services['plugins'] = $this->get('plugins_factory')->factory($this, $this->get('loader'), $this->get('events'), $this->get('application'), array('Default' => '/var/www/html/shopware5_4/engine/Shopware/Plugins/Default/', 'Local' => '/var/www/html/shopware5_4/engine/Shopware/Plugins/Local/', 'Community' => '/var/www/html/shopware5_4/engine/Shopware/Plugins/Community/', 'ShopwarePlugins' => '/var/www/html/shopware5_4/custom/plugins/', 'ProjectPlugins' => '/var/www/html/shopware5_4/custom/project/'));
    }
    ...
    {
        return $this->services['registration_cleanup_cron_job_subscriber'] = new \Shopware\Components\Register\RegistrationCleanupSubscriber($this->get('shopware.components.registration_cleanup_service'));
    }
    ...
    {
        return $this->services['shopware.components.optin_cleanup_service'] = new \Shopware\Components\Register\OptinCleanupService($this->get('config'), $this->get('dbal_connection'));
    }
    protected function getShopware_Components_Privacy_CookieRemoveSubscriberService()
    {
        return $this->services['shopware.components.privacy.cookie_remove_subscriber'] = new \Shopware\Components\Privacy\CookieRemoveSubscriber($this->get('config'));
    }
    protected function getShopware_Components_Privacy_IpAnonymizerService()
    {
        return $this->services['shopware.components.privacy.ip_anonymizer'] = new \Shopware\Components\Privacy\ConfigDependentIpAnonymizer(new \Shopware\Components\Privacy\IpAnonymizer(), $this->get('config'));
    }
    protected function getShopware_Components_Privacy_PrivacyCleanupCronSubscriberService()
    {
        return $this->services['shopware.components.privacy.privacy_cleanup_cron_subscriber'] = new \Shopware\Components\Privacy\PrivacyCleanupCronSubscriber($this->get('shopware.components.privacy.privacy_service'), $this->get('config'));
    }
    protected function getShopware_Components_Privacy_PrivacyServiceService()
    {
        return $this->services['shopware.components.privacy.privacy_service'] = new \Shopware\Components\Privacy\PrivacyService($this->get('dbal_connection'));
    }
    protected function getShopware_Components_RegistrationCleanupServiceService()
    {
        return $this->services['shopware.components.registration_cleanup_service'] = new \Shopware\Components\Register\RegistrationCleanupService($this->get('config'), $this->get('dbal_connection'));
    }
    ...
    {
        return $this->services['shopware.openssl_verificator'] = new \Shopware\Components\OpenSSLVerifier('/var/www/html/shopware5_4/engine/Shopware/Components/HttpClient/public.key');
    }
    ...
    {
        return $this->services['shopware.release'] = new \Shopware\Components\ShopwareReleaseStruct('5.4.6', '', '201807181357');
    }
    protected function getShopware_RequirementsService()
    {
        return $this->services['shopware.requirements'] = new \Shopware\Components\Check\Requirements('/var/www/html/shopware5_4/engine/Shopware/Components/Check/Data/System.xml', $this->get('db_connection'));
    }
    ...
    {
        return $this->services['shopware.snippet_database_handler'] = new \Shopware\Components\Snippet\DatabaseHandler($this->get('models'), $this->get('db'), '/var/www/html/shopware5_4');
    }
    protected function getShopware_SnippetQueryHandlerService()
    {
        return $this->services['shopware.snippet_query_handler'] = new \Shopware\Components\Snippet\QueryHandler('/var/www/html/shopware5_4/snippets/');
    }
    ...
    {
        return $this->services['shopware_account.customer_unlock_service'] = new \Shopware\Bundle\AccountBundle\Service\CustomerUnlockService($this->get('dbal_connection'));
    }
    ...
    {
        return $this->services['shopware_searchdbal.dbal_query_builder_factory'] = new \Shopware\Bundle\SearchBundleDBAL\QueryBuilderFactory($this->get('dbal_connection'), $this->get('events'), array(0 => $this->get('shopware_searchdbal.vote_average_condition_handler_dbal'), 1 => $this->get('shopware_searchdbal.weight_condition_handler'), 2 => $this->get('shopware_searchdbal.width_condition_handler'), 3 => $this->get('shopware_searchdbal.length_condition_handler'), 4 => $this->get('shopware_searchdbal.height_condition_handler'), 5 => $this->get('shopware_bundle.search_bundle_dbal_condition_handler.variant_condition_handler'), 6 => $this->get('shopware_searchdbal.combined_condition_handler_dbal'), 7 => $this->get('shopware_searchdbal.last_id_condition_handler_dbal'), 8 => $this->get('shopware_searchdbal.similar_products_handler_dbal'), 9 => $this->get('shopware_searchdbal.price_condition_handler_dbal'), 10 => $this->get('shopware_searchdbal.sales_condition_handler_dbal'), 11 => $this->get('shopware_searchdbal.shipping_free_condition_handler_dbal'), 12 => $this->get('shopware_searchdbal.property_condition_handler_dbal'), 13 => $this->get('shopware_searchdbal.manufacturer_condition_handler_dbal'), 14 => $this->get('shopware_searchdbal.immediate_delivery_condition_handler_dbal'), 15 => $this->get('shopware_searchdbal.customer_group_condition_handler_dbal'), 16 => $this->get('shopware_searchdbal.product_attribute_condition_handler_dbal'), 17 => $this->get('shopware_searchdbal.productid_condition_handler_dbal'), 18 => $this->get('shopware_searchdbal.ordernumber_condition_handler_dbal'), 19 => $this->get('shopware_searchdbal.category_condition_handler_dbal'), 20 => $this->get('shopware_searchdbal.search_condition_handler_dbal'), 21 => $this->get('shopware_searchdbal.create_date_condition_handler'), 22 => $this->get('shopware_searchdbal.release_date_condition_handler'), 23 => $this->get('shopware_searchdbal.is_new_condition_handler_dbal'), 24 => $this->get('shopware_searchdbal.has_pseudo_price_condition_handler_dbal'), 25 => $this->get('shopware_searchdbal.closeout_condition_handler_dbal'), 26 => $this->get('shopware_searchdbal.is_available_condition_handler_dbal')), array(0 => $this->get('shopware_searchdbal.product_name_sorting_handler_dbal'), 1 => $this->get('shopware_searchdbal.product_stock_sorting_handler_dbal'), 2 => $this->get('shopware_searchdbal.random_sorting_handler_dbal'), 3 => $this->get('shopware_searchdbal.search_ranking_sorting_handler_dbal'), 4 => $this->get('shopware_searchdbal.price_sorting_handler_sorting_handler_dbal'), 5 => $this->get('shopware_searchdbal.release_date_sorting_handler_dbal'), 6 => $this->get('shopware_searchdbal.shopware_searchdbal.product_attribute_sorting_handler_dbal'), 7 => $this->get('shopware_searchdbal.popularity_sorting_handler_dbal')), $this);
    }
    ...
    {
        return $this->services['shopware_searchdbal.search_indexer'] = new \Shopware\Bundle\SearchBundleDBAL\SearchTerm\SearchIndexer($this->get('config'), $this->get('dbal_connection'), $this->get('shopware_searchdbal.search_term_helper'), 4000);
    }
    ...
    {
        return $this->services['sitemapxml.repository'] = new \Shopware\Components\SitemapXMLRepository($this->get('shopware_search.product_number_search'), $this->get('shopware_search.store_front_criteria_factory'), $this->get('models'), $this->get('shopware_storefront.context_service'), 10000);
    }
    ...
    {
        return $this->services['theme_compiler'] = new \Shopware\Components\Theme\Compiler('/var/www/html/shopware5_4/', $this->get('oyejorge_compiler'), $this->get('theme_path_resolver'), $this->get('theme_inheritance'), $this->get('theme_service'), $this->get('js_compressor'), $this->get('events'), $this->get('theme_timestamp_persistor'), $this->get('shopware.release'));
    }
    ...
    {
        return $this->services['theme_path_resolver'] = new \Shopware\Components\Theme\PathResolver('/var/www/html/shopware5_4/', array('Default' => '/var/www/html/shopware5_4/engine/Shopware/Plugins/Default/', 'Local' => '/var/www/html/shopware5_4/engine/Shopware/Plugins/Local/', 'Community' => '/var/www/html/shopware5_4/engine/Shopware/Plugins/Community/', 'ShopwarePlugins' => '/var/www/html/shopware5_4/custom/plugins/', 'ProjectPlugins' => '/var/www/html/shopware5_4/custom/project/'), '/var/www/html/shopware5_4/themes/', '/var/www/html/shopware5_4/web/cache/', $this->get('shopware.release'));
    }
    ...
    {
        return $this->services['thumbnail_manager'] = new \Shopware\Components\Thumbnail\Manager($this->get('thumbnail_generator_basic'), '/var/www/html/shopware5_4/', $this->get('events'), $this->get('shopware_media.media_service'));
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/var/www/html/shopware5_4',
            'kernel.environment' => 'production',
            'kernel.debug' => false,
            'kernel.name' => 'Shopware',
            'kernel.cache_dir' => '/var/www/html/shopware5_4/var/cache/production_201807181357',
            'kernel.logs_dir' => '/var/www/html/shopware5_4/var/log',
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'ShopwareProductionda39a3ee5e6b4b0d3255bfef95601890afd80709ProjectContainer',
            'shopware.release.version' => '5.4.6',
            'shopware.release.version_text' => '',
            'shopware.release.revision' => '201807181357',
            ...
            'shopware.cdn.adapters.local.path' => '/var/www/html/shopware5_4',
            ...
            'shopware.db.host' => 'db_shopware5_4',
            ...
            'shopware.plugin_directories' => array(
                'Default' => '/var/www/html/shopware5_4/engine/Shopware/Plugins/Default/',
                'Local' => '/var/www/html/shopware5_4/engine/Shopware/Plugins/Local/',
                'Community' => '/var/www/html/shopware5_4/engine/Shopware/Plugins/Community/',
                'ShopwarePlugins' => '/var/www/html/shopware5_4/custom/plugins/',
                'ProjectPlugins' => '/var/www/html/shopware5_4/custom/project/',
            ),
            'shopware.plugin_directories.default' => '/var/www/html/shopware5_4/engine/Shopware/Plugins/Default/',
            'shopware.plugin_directories.local' => '/var/www/html/shopware5_4/engine/Shopware/Plugins/Local/',
            'shopware.plugin_directories.community' => '/var/www/html/shopware5_4/engine/Shopware/Plugins/Community/',
            'shopware.plugin_directories.shopwareplugins' => '/var/www/html/shopware5_4/custom/plugins/',
            'shopware.plugin_directories.projectplugins' => '/var/www/html/shopware5_4/custom/project/',
            'shopware.template' => array(
                ...
                'charset' => 'utf-8',
                'forceCache' => false,
                'cacheDir' => '/var/www/html/shopware5_4/var/cache/production_201807181357/templates',
                'compileDir' => '/var/www/html/shopware5_4/var/cache/production_201807181357/templates',
                'templateDir' => '/var/www/html/shopware5_4/themes/',
            ),
            ...
            'shopware.template.cachedir' => '/var/www/html/shopware5_4/var/cache/production_201807181357/templates',
            'shopware.template.compiledir' => '/var/www/html/shopware5_4/var/cache/production_201807181357/templates',
            'shopware.template.templatedir' => '/var/www/html/shopware5_4/themes/',
            'shopware.mail' => array(
                'charset' => 'utf-8',
            ),
            ...
            'shopware.httpcache' => array(
                ...
                'cache_dir' => '/var/www/html/shopware5_4/var/cache/production_201807181357/html',
                'cache_cookies' => array(
                    0 => 'shop',
                    1 => 'currency',
            ...
            'shopware.httpcache.cache_dir' => '/var/www/html/shopware5_4/var/cache/production_201807181357/html',
            ...
            'shopware.cache' => array(
                'frontendOptions' => array(
                    ...
                    'lifetime' => 3600,
                    'cache_id_prefix' => 'ab951cb28e3dfd3c50f80da67e7a13b5',
                ),
                'backend' => 'auto',
                'backendOptions' => array(
                    ...
                    'cache_dir' => '/var/www/html/shopware5_4/var/cache/production_201807181357/general',
            ...
            'shopware.cache.frontendoptions.cache_id_prefix' => 'ab951cb28e3dfd3c50f80da67e7a13b5',
            ...
            'shopware.cache.backendoptions.cache_dir' => '/var/www/html/shopware5_4/var/cache/production_201807181357/general',
            'shopware.cache.backendoptions.file_name_prefix' => 'shopware',
            'shopware.hook' => array(
                'proxyDir' => '/var/www/html/shopware5_4/var/cache/production_201807181357/proxies',
                'proxyNamespace' => 'Shopware_Proxies',
            ),
            'shopware.hook.proxydir' => '/var/www/html/shopware5_4/var/cache/production_201807181357/proxies',
            'shopware.hook.proxynamespace' => 'Shopware_Proxies',
            'shopware.model' => array(
                'autoGenerateProxyClasses' => false,
                'attributeDir' => '/var/www/html/shopware5_4/var/cache/production_201807181357/doctrine/attributes',
                'proxyDir' => '/var/www/html/shopware5_4/var/cache/production_201807181357/doctrine/proxies',
                'proxyNamespace' => 'Shopware\\Proxies',
                'cacheProvider' => 'auto',
                'cacheNamespace' => NULL,
            ),
            'shopware.model.autogenerateproxyclasses' => false,
            'shopware.model.attributedir' => '/var/www/html/shopware5_4/var/cache/production_201807181357/doctrine/attributes',
            'shopware.model.proxydir' => '/var/www/html/shopware5_4/var/cache/production_201807181357/doctrine/proxies',
            ...
            'shopware.app' => array(
                'rootDir' => '/var/www/html/shopware5_4/',
                'downloadsDir' => '/var/www/html/shopware5_4/files/downloads/',
                'documentsDir' => '/var/www/html/shopware5_4/files/documents/',
            ),
            'shopware.app.rootdir' => '/var/www/html/shopware5_4/',
            'shopware.app.downloadsdir' => '/var/www/html/shopware5_4/files/downloads/',
            'shopware.app.documentsdir' => '/var/www/html/shopware5_4/files/documents/',
            'shopware.web' => array(
                'webDir' => '/var/www/html/shopware5_4/web/',
                'cacheDir' => '/var/www/html/shopware5_4/web/cache/',
            ),
            'shopware.web.webdir' => '/var/www/html/shopware5_4/web/',
            'shopware.web.cachedir' => '/var/www/html/shopware5_4/web/cache/',

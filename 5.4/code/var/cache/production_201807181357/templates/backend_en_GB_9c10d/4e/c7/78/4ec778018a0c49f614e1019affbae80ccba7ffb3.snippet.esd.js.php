<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 22:04:09
         compiled from "/var/www/html/shopware5_4/themes/Backend/ExtJs/backend/article/controller/esd.js" */ ?>
<?php /*%%SmartyHeaderCode:18434780995f6baa39c58fb5-71923302%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4ec778018a0c49f614e1019affbae80ccba7ffb3' => 
    array (
      0 => '/var/www/html/shopware5_4/themes/Backend/ExtJs/backend/article/controller/esd.js',
      1 => 1531915062,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18434780995f6baa39c58fb5-71923302',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6baa39c69df1_94523593',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6baa39c69df1_94523593')) {function content_5f6baa39c69df1_94523593($_smarty_tpl) {?>/**
 * Shopware 5
...
'
    ...
    onAddEsd: function(articleDetailId) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_4/backend/Article/createEsd';?>',
            method: 'POST',
            params: {
    ...
    saveNewSerials: function(serials) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_4/backend/Article/saveSerials';?>',
            method: 'POST',
            params: {
    ...
    onDeleteUnusedSerials: function() {
        ...
        Ext.MessageBox.confirm(me.snippets.growlMessage, me.snippets.messages.serialsRemoveUnused , function (response) {
            ...
            Ext.Ajax.request({
                url: '<?php echo '/shopware5_4/backend/Article/deleteUnusedSerials';?>',
                method: 'POST',
                params: {
                    esdId: me.detailWindow.esdRecord.get('id')
                },
    ...
    onDownloadFile: function() {
        ...
        var url = '<?php echo '/shopware5_4/backend/Article/getEsdDownload';?>' + '/filename/' + record.get('file');

<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 22:04:09
         compiled from "/var/www/html/shopware5_4/themes/Backend/ExtJs/backend/customer/controller/stream.js" */ ?>
<?php /*%%SmartyHeaderCode:10781564505f6baa39b2a175-95353768%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3124763e914091f7aad38e112938a5ce17701496' => 
    array (
      0 => '/var/www/html/shopware5_4/themes/Backend/ExtJs/backend/customer/controller/stream.js',
      1 => 1531915062,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10781564505f6baa39b2a175-95353768',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6baa39b42433_79947604',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6baa39b42433_79947604')) {function content_5f6baa39b42433_79947604($_smarty_tpl) {?>/**
 * Shopware 5
...
Ext.define('Shopware.apps.Customer.controller.Stream', {
    ...
    addCustomerToStream: function(record) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_4/backend/CustomerStream/addCustomerToStream';?>',
            params: {
...
');
    ...
    deleteCustomerFromStream: function(record) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_4/backend/CustomerStream/removeCustomerFromStream';?>',
            params: {
                streamId: stream.get('id'),
                customerId: record.get('id')
            },
...
', next.get('name'), total - streams.length, total),
    ...
    checkIndexState: function() {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_4/backend/CustomerStream/getNotIndexedCount';?>',
...
<?php $_tmp2=ob_get_clean();?><?php if (!$_tmp2){?>*/
    ...
    changeAutoIndex: function(checkbox, newValue) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_4/backend/UserConfig/save';?>',
            params: {
...
<?php $_tmp9=ob_get_clean();?><?php if (!$_tmp9){?>*/
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_4/backend/CustomerStream/loadStream';?>',
            params: {
            ...
            success: function(operation) {
                ...
                me.start(
                    [{
                        url: '<?php echo '/shopware5_4/backend/CustomerStream/indexStream';?>',
                        params: {
...
<?php $_tmp10=ob_get_clean();?><?php if (!$_tmp10){?>*/
        ...
        me.getSearchIndexingParameters(force, function(params) {
            me.start(
                [{
                    url: '<?php echo '/shopware5_4/backend/CustomerStream/buildSearchIndex';?>',
                    params: params
                }],
                callback
            );
    ...
    getSearchIndexingParameters: function(force, callback) {
        Ext.Ajax.request({
            ...
            success: function(operation) {
                ...
                Ext.Ajax.request({
                    url: '<?php echo '/shopware5_4/backend/CustomerStream/getCustomerCount';?>',
                    params: {},
                    success: function (operation) {
    ...
    resetProgressbar: function () {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_4/backend/CustomerStream/getLastFullIndexTime';?>',
            success: function(operation) {
                var response = Ext.decode(operation.responseText);
                Ext.defer(function () {

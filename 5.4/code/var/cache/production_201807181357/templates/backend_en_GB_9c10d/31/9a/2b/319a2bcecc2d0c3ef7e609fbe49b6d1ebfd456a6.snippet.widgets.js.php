<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 22:04:08
         compiled from "/var/www/html/shopware5_4/themes/Backend/ExtJs/backend/index/controller/widgets.js" */ ?>
<?php /*%%SmartyHeaderCode:6865296925f6baa38740fa9-32344734%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '319a2bcecc2d0c3ef7e609fbe49b6d1ebfd456a6' => 
    array (
      0 => '/var/www/html/shopware5_4/themes/Backend/ExtJs/backend/index/controller/widgets.js',
      1 => 1531915062,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6865296925f6baa38740fa9-32344734',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6baa3874c689_45781174',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6baa3874c689_45781174')) {function content_5f6baa3874c689_45781174($_smarty_tpl) {?>/**
 * Shopware 5
...
<?php $_tmp1=ob_get_clean();?><?php if ($_tmp1){?>*/
    ...
    onSaveWidgetPosition: function (column, row, internalId) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_4/backend/widgets/savePosition';?>',
            params: {
                column: column,
                position: row,
                id: internalId
    ...
    onSaveWidgetPositions: function (widgets) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_4/backend/widgets/savePositions';?>',
            jsonData: {
                widgets: widgets
            },
    ...
    onAddWidget: function (win, widgetName, menuItem) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_4/backend/widgets/addWidgetView';?>',
            jsonData: {
                id: widget.get('id'),
                column: 0,
    ...
    onCloseWidget: function (widget) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_4/backend/widgets/removeWidgetView';?>',
            params: {
                id: widget.viewId
            },
            callback: function (options, success, res) {
    ...
    onOpenMerchantDetail: function (mode, record) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_4/backend/widgets/requestMerchantForm';?>',
            params: {
                id: ~~(1 * record.get('id')),

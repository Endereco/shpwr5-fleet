<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 22:04:08
         compiled from "/var/www/html/shopware5_4/themes/Backend/ExtJs/backend/index/controller/main.js" */ ?>
<?php /*%%SmartyHeaderCode:7157763105f6baa38723c61-32437615%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '46d9fa8f98f3612c2bf486a0ecab5b3f61e10ed7' => 
    array (
      0 => '/var/www/html/shopware5_4/themes/Backend/ExtJs/backend/index/controller/main.js',
      1 => 1531915062,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7157763105f6baa38723c61-32437615',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f6baa3873dc55_02545414',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6baa3873dc55_02545414')) {function content_5f6baa3873dc55_02545414($_smarty_tpl) {?>/**
 * Shopware 5
...
<?php $_tmp6=ob_get_clean();?><?php if ($_tmp6){?>*/
    ...
    checkLoginStatus: function() {
        Ext.TaskManager.start({
            ...
            run: function() {
                Ext.Ajax.request({
                    url: '<?php echo '/shopware5_4/backend/login/getLoginStatus';?>',
                    success: function(response) {
                        var json = Ext.decode(response.responseText);

                        if(!json.success) {
                            window.location.href = '<?php echo '/shopware5_4/backend';?>';
                        }
                    },
                    failure: function() {
                        window.location.href = '<?php echo '/shopware5_4/backend';?>';

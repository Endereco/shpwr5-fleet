<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 22:04:08
         compiled from "/var/www/html/shopware5_4/themes/Backend/ExtJs/backend/base/store/product_box_layout.js" */ ?>
<?php /*%%SmartyHeaderCode:10460134495f6baa3822a1d6-00592429%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'adbce8f7b5402f1adf15f076b0886a5a7a6e892b' => 
    array (
      0 => '/var/www/html/shopware5_4/themes/Backend/ExtJs/backend/base/store/product_box_layout.js',
      1 => 1531915062,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10460134495f6baa3822a1d6-00592429',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6baa38233695_75793275',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6baa38233695_75793275')) {function content_5f6baa38233695_75793275($_smarty_tpl) {?>/**
 * Shopware 5
    ...
    constructor: function(config) {
        ...
        if (this.getConfigValue(config, 'displayExtendLayout')) {
            data.push({
                ...
                image: '/shopware5_4/themes/Backend/ExtJs/backend/_resources/images/category/layout_box_parent.png'
            });
        }
        if (this.getConfigValue(config, 'displayBasicLayout')) {
            data.push({
                ...
                image: '/shopware5_4/themes/Backend/ExtJs/backend/_resources/images/category/layout_box_basic.png'
            });
        }
        if (this.getConfigValue(config, 'displayMinimalLayout')) {
            data.push({
                ...
                image: '/shopware5_4/themes/Backend/ExtJs/backend/_resources/images/category/layout_box_minimal.png'
            });
        }
        if (this.getConfigValue(config, 'displayImageLayout')) {
            data.push({
                ...
                image: '/shopware5_4/themes/Backend/ExtJs/backend/_resources/images/category/layout_box_image.png'
            });
        }
        if (this.getConfigValue(config, 'displayListLayout')) {
            data.push({
                ...
                image: '/shopware5_4/themes/Backend/ExtJs/backend/_resources/images/category/layout_box_list.png'
            });
        }

<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 22:04:09
         compiled from "/var/www/html/shopware5_4/themes/Backend/ExtJs/backend/article_list/controller/batch_process.js" */ ?>
<?php /*%%SmartyHeaderCode:9200821385f6baa39a4d8f4-20062329%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ae591c6878b4ac0875c91e3b30c700918be39f88' => 
    array (
      0 => '/var/www/html/shopware5_4/themes/Backend/ExtJs/backend/article_list/controller/batch_process.js',
      1 => 1531915062,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9200821385f6baa39a4d8f4-20062329',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6baa39a5f3e7_70409905',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6baa39a5f3e7_70409905')) {function content_5f6baa39a5f3e7_70409905($_smarty_tpl) {?>/**
 * Shopware 5
...
');
    ...
    addToQueue: function(config, offset, queueId, startTime) {
        ...
        Ext.Ajax.request({
            type: "POST",
            url: '<?php echo '/shopware5_4/backend/ArticleList/createQueue';?>',
            timeout: 4000000,
            params : {
                resource: 'product',
...
');
    ...
    runBatchProcess: function(queueId, config, startTime) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_4/backend/ArticleList/batch';?>',
            timeout: 4000000,
            params : {
                resource: 'product',
                limit: 200,

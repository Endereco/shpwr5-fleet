<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 22:04:09
         compiled from "/var/www/html/shopware5_4/themes/Backend/ExtJs/backend/product_stream/controller/main.js" */ ?>
<?php /*%%SmartyHeaderCode:19961978135f6baa399b5502-05107341%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '89ebfdcd2b5a796f8e21e495fa7e2303afe477b5' => 
    array (
      0 => '/var/www/html/shopware5_4/themes/Backend/ExtJs/backend/product_stream/controller/main.js',
      1 => 1531915062,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19961978135f6baa399b5502-05107341',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6baa399bf703_72194292',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6baa399bf703_72194292')) {function content_5f6baa399bf703_72194292($_smarty_tpl) {?>/**
 * Shopware 5
                ...
                duplicatedRecord.save({
                    success: function (newRecord) {
                        if (newRecord.get('type') == 2) {
                            Ext.Ajax.request({
                                url: '<?php echo '/shopware5_4/backend/ProductStream/copySelectedProducts';?>',
                                params: {
                        ...
                        Ext.Ajax.request({
                            url: '<?php echo '/shopware5_4/backend/ProductStream/copyStreamAttributes';?>',
                            params: {
                                sourceStreamId: record.get('id'),
                                targetStreamId: newRecord.get('id')
                            }

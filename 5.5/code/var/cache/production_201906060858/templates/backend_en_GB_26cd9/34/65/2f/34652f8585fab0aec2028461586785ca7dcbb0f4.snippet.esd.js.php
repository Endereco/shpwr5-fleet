<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 22:02:19
         compiled from "/var/www/html/shopware5_5/themes/Backend/ExtJs/backend/article/controller/esd.js" */ ?>
<?php /*%%SmartyHeaderCode:18726965595f6ba9cbedd305-74396334%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '34652f8585fab0aec2028461586785ca7dcbb0f4' => 
    array (
      0 => '/var/www/html/shopware5_5/themes/Backend/ExtJs/backend/article/controller/esd.js',
      1 => 1559804334,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18726965595f6ba9cbedd305-74396334',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6ba9cbeedd45_76324276',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6ba9cbeedd45_76324276')) {function content_5f6ba9cbeedd45_76324276($_smarty_tpl) {?>/**
 * Shopware 5
...
'
    ...
    onAddEsd: function(articleDetailId) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_5/backend/Article/createEsd';?>',
            method: 'POST',
            params: {
    ...
    saveNewSerials: function(serials) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_5/backend/Article/saveSerials';?>',
            method: 'POST',
            params: {
    ...
    onDeleteUnusedSerials: function() {
        ...
        Ext.MessageBox.confirm(me.snippets.growlMessage, me.snippets.messages.serialsRemoveUnused , function (response) {
            ...
            Ext.Ajax.request({
                url: '<?php echo '/shopware5_5/backend/Article/deleteUnusedSerials';?>',
                method: 'POST',
                params: {
                    esdId: me.detailWindow.esdRecord.get('id')
                },
    ...
    onDownloadFile: function() {
        ...
        var url = '<?php echo '/shopware5_5/backend/Article/getEsdDownload';?>' + '/filename/' + record.get('file');

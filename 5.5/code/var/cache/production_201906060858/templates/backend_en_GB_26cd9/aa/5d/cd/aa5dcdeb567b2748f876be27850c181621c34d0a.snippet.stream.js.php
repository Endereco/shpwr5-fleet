<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 22:02:19
         compiled from "/var/www/html/shopware5_5/themes/Backend/ExtJs/backend/customer/controller/stream.js" */ ?>
<?php /*%%SmartyHeaderCode:13066539625f6ba9cbe24e47-08441565%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'aa5dcdeb567b2748f876be27850c181621c34d0a' => 
    array (
      0 => '/var/www/html/shopware5_5/themes/Backend/ExtJs/backend/customer/controller/stream.js',
      1 => 1559804334,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13066539625f6ba9cbe24e47-08441565',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6ba9cbe3cdc6_52406182',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6ba9cbe3cdc6_52406182')) {function content_5f6ba9cbe3cdc6_52406182($_smarty_tpl) {?>/**
 * Shopware 5
...
Ext.define('Shopware.apps.Customer.controller.Stream', {
    ...
    addCustomerToStream: function(record) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_5/backend/CustomerStream/addCustomerToStream';?>',
            params: {
...
');
    ...
    deleteCustomerFromStream: function(record) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_5/backend/CustomerStream/removeCustomerFromStream';?>',
            params: {
                streamId: stream.get('id'),
                customerId: record.get('id')
            },
...
', next.get('name'), total - streams.length, total),
    ...
    checkIndexState: function() {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_5/backend/CustomerStream/getNotIndexedCount';?>',
...
<?php $_tmp9=ob_get_clean();?><?php if (!$_tmp9){?>*/
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_5/backend/CustomerStream/loadStream';?>',
            params: {
            ...
            success: function(operation) {
                ...
                me.start(
                    [{
                        url: '<?php echo '/shopware5_5/backend/CustomerStream/indexStream';?>',
                        params: {
...
<?php $_tmp10=ob_get_clean();?><?php if (!$_tmp10){?>*/
        ...
        me.getSearchIndexingParameters(force, function(params) {
            me.start(
                [{
                    url: '<?php echo '/shopware5_5/backend/CustomerStream/buildSearchIndex';?>',
                    params: params
                }],
                callback
            );
    ...
    getSearchIndexingParameters: function(force, callback) {
        Ext.Ajax.request({
            ...
            success: function(operation) {
                ...
                Ext.Ajax.request({
                    url: '<?php echo '/shopware5_5/backend/CustomerStream/getCustomerCount';?>',
                    params: {},
                    success: function (operation) {
    ...
    resetProgressbar: function () {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_5/backend/CustomerStream/getLastFullIndexTime';?>',
            success: function(operation) {
                var response = Ext.decode(operation.responseText);
                Ext.defer(function () {

<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 22:02:19
         compiled from "/var/www/html/shopware5_5/themes/Backend/ExtJs/backend/article_list/controller/batch_process.js" */ ?>
<?php /*%%SmartyHeaderCode:16487835315f6ba9cbc84aa0-67502691%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1cfbec934a5153a16825f56b0fcddea90e6858fc' => 
    array (
      0 => '/var/www/html/shopware5_5/themes/Backend/ExtJs/backend/article_list/controller/batch_process.js',
      1 => 1559804334,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16487835315f6ba9cbc84aa0-67502691',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6ba9cbc96434_46593895',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6ba9cbc96434_46593895')) {function content_5f6ba9cbc96434_46593895($_smarty_tpl) {?>/**
 * Shopware 5
...
');
    ...
    addToQueue: function(config, offset, queueId, startTime) {
        ...
        Ext.Ajax.request({
            type: 'POST',
            url: '<?php echo '/shopware5_5/backend/ArticleList/createQueue';?>',
            timeout: 4000000,
            params : {
                resource: 'product',
...
');
    ...
    runBatchProcess: function(queueId, config, startTime) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_5/backend/ArticleList/batch';?>',
            timeout: 4000000,
            params : {
                resource: 'product',
                limit: 200,

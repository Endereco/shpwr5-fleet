<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 22:02:18
         compiled from "/var/www/html/shopware5_5/themes/Backend/ExtJs/backend/index/controller/main.js" */ ?>
<?php /*%%SmartyHeaderCode:3689787925f6ba9ca970994-09479259%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6060354e12ff60c4fb7be25e7cde8390a378a6e5' => 
    array (
      0 => '/var/www/html/shopware5_5/themes/Backend/ExtJs/backend/index/controller/main.js',
      1 => 1559804334,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3689787925f6ba9ca970994-09479259',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f6ba9ca990ad5_34991320',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6ba9ca990ad5_34991320')) {function content_5f6ba9ca990ad5_34991320($_smarty_tpl) {?>/**
 * Shopware 5
...
<?php $_tmp8=ob_get_clean();?><?php if ($_tmp8){?>*/
    ...
    checkLoginStatus: function () {
        Ext.TaskManager.start({
            ...
            run: function () {
                Ext.Ajax.request({
                    url: '<?php echo '/shopware5_5/backend/login/getLoginStatus';?>',
                    success: function(response) {
                        var json = Ext.decode(response.responseText);

                        if(!json.success) {
                            window.location.href = '<?php echo '/shopware5_5/backend';?>';
                        }
                    },
                    failure: function() {
                        window.location.href = '<?php echo '/shopware5_5/backend';?>';
    ...
    checkBenchmarksStatus: function () {
        var interval = 10000,
            checkBenchmarksFn = function () {
                Ext.Ajax.request({
                    url: '<?php echo '/shopware5_5/backend/benchmark/checkBenchmarks';?>',
                    success: function(response) {

<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 22:02:19
         compiled from "/var/www/html/shopware5_5/themes/Backend/ExtJs/backend/customer/controller/detail.js" */ ?>
<?php /*%%SmartyHeaderCode:1570893435f6ba9cbdf5f19-89518694%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fdab11b96cd33c0808f23b9cef4e89d3dfc9bf3a' => 
    array (
      0 => '/var/www/html/shopware5_5/themes/Backend/ExtJs/backend/customer/controller/detail.js',
      1 => 1559804334,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1570893435f6ba9cbdf5f19-89518694',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6ba9cbe1aff7_66850089',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6ba9cbe1aff7_66850089')) {function content_5f6ba9cbe1aff7_66850089($_smarty_tpl) {?>/**
 * Shopware 5
...
',
            message: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'overwriteCustomer'/'message','default'=>'Do you really want to overwrite the latest changes?','namespace'=>'backend/customer/view/detail')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'overwriteCustomer'/'message','default'=>'Do you really want to overwrite the latest changes?','namespace'=>'backend/customer/view/detail'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
The customer has been changed by another user in the meantime. To prevent overwriting these changes, saving the customer was aborted. To show these changes, please close the customer and re-open it.<br /><br /><b>Do you want to overwrite the latest changes?</b><?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'overwriteCustomer'/'message','default'=>'Do you really want to overwrite the latest changes?','namespace'=>'backend/customer/view/detail'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
        },

        unlock: {
            successTitle: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'base'/'unlock_customer'/'success_title','default'=>'Successfully','namespace'=>'backend/customer/view/detail')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'base'/'unlock_customer'/'success_title','default'=>'Successfully','namespace'=>'backend/customer/view/detail'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Successfully<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'base'/'unlock_customer'/'success_title','default'=>'Successfully','namespace'=>'backend/customer/view/detail'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            successText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'base'/'unlock_customer'/'success_text','default'=>'Successfully unlocked the customer.','namespace'=>'backend/customer/view/detail')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'base'/'unlock_customer'/'success_text','default'=>'Successfully unlocked the customer.','namespace'=>'backend/customer/view/detail'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Successfully unlocked the customer.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'base'/'unlock_customer'/'success_text','default'=>'Successfully unlocked the customer.','namespace'=>'backend/customer/view/detail'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            errorTitle: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'base'/'unlock_customer'/'error_title','default'=>'Failure','namespace'=>'backend/customer/view/detail')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'base'/'unlock_customer'/'error_title','default'=>'Failure','namespace'=>'backend/customer/view/detail'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Failure<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'base'/'unlock_customer'/'error_title','default'=>'Failure','namespace'=>'backend/customer/view/detail'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            errorText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'base'/'unlock_customer'/'error_text','default'=>'An error occurred while unlocking the customer.','namespace'=>'backend/customer/view/detail')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'base'/'unlock_customer'/'error_text','default'=>'An error occurred while unlocking the customer.','namespace'=>'backend/customer/view/detail'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
An error occurred while unlocking the customer.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'base'/'unlock_customer'/'error_text','default'=>'An error occurred while unlocking the customer.','namespace'=>'backend/customer/view/detail'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
        },
...
<?php $_tmp1=ob_get_clean();?><?php if ($_tmp1){?> */
    ...
    onPerformOrder: function (record) {
        window.open('<?php echo '/shopware5_5/backend/customer/performOrder';?>?id=' + record.get('id') + '&__csrf_token=' + Ext.CSRFService.getToken());
    },
...
';
    ...
    onUnlockCustomer: function (unlockContainer, record) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_5/backend/customer/unlockCustomer';?>',
            params: {

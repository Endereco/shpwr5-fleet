<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 22:02:19
         compiled from "/var/www/html/shopware5_5/themes/Backend/ExtJs/backend/article_list/controller/main.js" */ ?>
<?php /*%%SmartyHeaderCode:12220292175f6ba9cbc4abf2-12157115%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '70a843d6901495a24331d4433640e2cbb9c4d0d1' => 
    array (
      0 => '/var/www/html/shopware5_5/themes/Backend/ExtJs/backend/article_list/controller/main.js',
      1 => 1559804334,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12220292175f6ba9cbc4abf2-12157115',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6ba9cbc51767_73086146',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6ba9cbc51767_73086146')) {function content_5f6ba9cbc51767_73086146($_smarty_tpl) {?>/**
 * Shopware 5
...
Ext.define('Shopware.apps.ArticleList.controller.Main', {
    ...
    loadDetailModelFields: function () {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware5_5/backend/ArticleList/columnConfig';?>',
            params: {
                resource: 'product'
            },
            method: 'GET',
    ...
    createDetailModel: function (data) {
        ...
        Ext.define('Shopware.apps.ArticleList.model.Detail', {
            ...
            proxy: {
                 ...
                 */
                api: {
                    create: '<?php echo '/shopware5_5/backend/ArticleList/saveSingleEntity';?>',
                    update: '<?php echo '/shopware5_5/backend/ArticleList/saveSingleEntity';?>',
                    destroy: '<?php echo '/shopware5_5/backend/ArticleList/deleteProduct';?>'
                },

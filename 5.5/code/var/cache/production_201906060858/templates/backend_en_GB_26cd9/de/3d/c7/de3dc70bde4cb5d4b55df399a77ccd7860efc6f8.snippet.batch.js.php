<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 22:02:19
         compiled from "/var/www/html/shopware5_5/themes/Backend/ExtJs/backend/order/controller/batch.js" */ ?>
<?php /*%%SmartyHeaderCode:7772268315f6ba9cbdf6db9-83040802%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'de3dc70bde4cb5d4b55df399a77ccd7860efc6f8' => 
    array (
      0 => '/var/www/html/shopware5_5/themes/Backend/ExtJs/backend/order/controller/batch.js',
      1 => 1559804334,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7772268315f6ba9cbdf6db9-83040802',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6ba9cbe1f2b0_19521879',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6ba9cbe1f2b0_19521879')) {function content_5f6ba9cbe1f2b0_19521879($_smarty_tpl) {?>/**
 * Shopware 5
...
'
        ...
        orderErrorTitle: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'batch'/'order_error'/'title','default'=>'Error at order [0]','namespace'=>'backend/order/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'batch'/'order_error'/'title','default'=>'Error at order [0]','namespace'=>'backend/order/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Error at order [0]<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'batch'/'order_error'/'title','default'=>'Error at order [0]','namespace'=>'backend/order/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
',
        formInvalid: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'settings'/'form_invalid','default'=>'Please correct the information in the form','namespace'=>'backend/order/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'settings'/'form_invalid','default'=>'Please correct the information in the form','namespace'=>'backend/order/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Please correct the information in the form<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'settings'/'form_invalid','default'=>'Please correct the information in the form','namespace'=>'backend/order/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
        noEmailsWillBeSent: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'batch'/'no_emails_will_be_sent','default'=>'Due to your current configuration no emails will be sent.','namespace'=>'backend/order/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'batch'/'no_emails_will_be_sent','default'=>'Due to your current configuration no emails will be sent.','namespace'=>'backend/order/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Due to your current configuration no emails will be sent.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'batch'/'no_emails_will_be_sent','default'=>'Due to your current configuration no emails will be sent.','namespace'=>'backend/order/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
    },
    ...
    createSingleDocument: function (orders) {
        ...
        if (settingValues.createSingleDocument) {
            ...
            window.open('<?php echo '/shopware5_5/backend/Order/mergeDocuments';?>?data=' + data, '_blank');
        }
    },

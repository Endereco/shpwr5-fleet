<?php /* Smarty version Smarty-3.1.12, created on 2020-09-23 22:02:18
         compiled from "/var/www/html/shopware5_5/themes/Backend/ExtJs/backend/base/store/product_box_layout.js" */ ?>
<?php /*%%SmartyHeaderCode:13463175125f6ba9ca470a06-63558354%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '103b17c93bb42a62558366d6d831a08ea5b5e345' => 
    array (
      0 => '/var/www/html/shopware5_5/themes/Backend/ExtJs/backend/base/store/product_box_layout.js',
      1 => 1559804334,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13463175125f6ba9ca470a06-63558354',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f6ba9ca47b612_46737636',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6ba9ca47b612_46737636')) {function content_5f6ba9ca47b612_46737636($_smarty_tpl) {?>/**
 * Shopware 5
    ...
    createLayoutData: function(config) {
        ...
        if (me.getConfigValue(config, 'displayExtendLayout')) {
            data.push({
                ...
                image: '/shopware5_5/themes/Backend/ExtJs/backend/_resources/images/category/layout_box_parent.png'
            });
        }
        if (me.getConfigValue(config, 'displayBasicLayout')) {
            data.push({
                ...
                image: '/shopware5_5/themes/Backend/ExtJs/backend/_resources/images/category/layout_box_basic.png'
            });
        }
        if (me.getConfigValue(config, 'displayMinimalLayout')) {
            data.push({
                ...
                image: '/shopware5_5/themes/Backend/ExtJs/backend/_resources/images/category/layout_box_minimal.png'
            });
        }
        if (me.getConfigValue(config, 'displayImageLayout')) {
            data.push({
                ...
                image: '/shopware5_5/themes/Backend/ExtJs/backend/_resources/images/category/layout_box_image.png'
            });
        }
        if (me.getConfigValue(config, 'displayListLayout')) {
            data.push({
                ...
                image: '/shopware5_5/themes/Backend/ExtJs/backend/_resources/images/category/layout_box_list.png'
            });
        }
